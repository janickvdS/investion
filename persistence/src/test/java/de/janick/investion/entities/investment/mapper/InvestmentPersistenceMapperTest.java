...
import de.janick.investion.entities.investment.model.INVESTMENTTYP;
...
class InvestmentPersistenceMapperTest {
    ...
    void mapINVESTMENTTYPFromDomain() {
        ...
        for (de.janick.investion.models.investment.model.INVESTMENTTYP typ : de.janick.investion.models.investment.model.INVESTMENTTYP.values()) {
    ...
    protected Investment createDomainModel() {
        return Investment.builder()
                .id(1L)
                .investmenttyp(de.janick.investion.models.investment.model.INVESTMENTTYP.AKTIE)
                .isin("DE1234")
                .symbol("AAPL")
                .wkn("A2D")
                .unternehmen("Apple")
